...
{
    public class CashflowEngineB : ICashflowEngineB
    {
        readonly IBankAccountRepository bankAccountRepository;
        readonly ITransferRepository transferRepository;
        readonly IAggregatedProjectionItemsGenerator aggregatedProjectionItemsGenerator;

        public CashflowEngineB(
                        ...
                        )
        {
            ...
            this.aggregatedProjectionItemsGenerator = aggregatedProjectionItemsGenerator;
        }
                                ...
                                decimal threshold)
        {
            ...
            List<CashflowProjectionItem> cpis = this.aggregatedProjectionItemsGenerator.GenerateAggregatedProjectionItems(cpts);  //GenerateAggregatedProjectionItems(cpts, mode);
